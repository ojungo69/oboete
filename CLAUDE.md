...
- **Scope**: the owner dropped the one-week trial (2026-09-23): finish every feature before any public release. Remaining: the other four agents (agy / Pi / OpenCode / Cursor, `docs/research/agent-adapters-2026-09-23.md`), semantic search and multi-device sync (`docs/research/search-sync-proposal-2026-09-23.md`, owner decisions pending), builds for WSL / Windows native / M1 iMac / arm64 VPS. OSS release is decided separately afterwards; a phone is on hold.
