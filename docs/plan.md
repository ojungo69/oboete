...
- 完了 = 全機能 (M2 / M3) が 4 台 (WSL / Windows / M1 iMac / arm64 VPS) で動くこと。OSS 公開は後で別に決める (owner 2026-09-23)。意味検索と同期の設計は `docs/research/search-sync-proposal-2026-09-23.md` で見直し中で、§2b・§3・§8 はそれで置き換える。
