...
- **Judge trust**:
  - The trust condition, from PR-B (proposal:240), with the panel in place of the owner (owner decision 29):
    ...
    - after that, Kendall τ ≥ 0.85 between the judge's system order and the panel majority's, measured on 20-30 questions whose pooled top 50 of every compared configuration is fully judged by the panel, never on scattered pairs (issue #30 row 22; Claude; overrulable).
