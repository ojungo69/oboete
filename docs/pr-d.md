...
|---|---|---|---|---|
| 全部 (110) nDCG@10 | 0.245 | 0.203 | 0.444 | **0.542**ᵃᵇᶜ |
| 全部 recall@10 | 0.054 | 0.040 | 0.145 | **0.194**ᵃᵇᶜ |
| 全部 hit@10 | 0.536 | 0.400 | 0.827 | **0.964**ᵃᵇᶜ |
| 日本語の問い (103) nDCG@10 | 0.228 | 0.192 | 0.439 | **0.543**ᵃᵇᶜ |
| 英語の問い (7) nDCG@10 | 0.491 | 0.363 | 0.514 | 0.527 |
| 90 日以内の prompt (29) nDCG@10 | 0.219 | 0.231 | 0.398 | **0.512**ᵃᵇᶜ |
| 問いより前に書かれた文書だけ (95) nDCG@10 | 0.212 | 0.071 | 0.432 | **0.538**ᵃᵇᶜ |
| 観測だけ (109) nDCG@10 | 0.260 | 0.216 | 0.442 | **0.537**ᵃᵇᶜ |

- **§3.3 の合格線を満たす**。nDCG@10 は e0 より +0.098 で有意。recall@10 はどの区画でも下がらない (いちばん差の小さい英語の 7 問でも 0.146 → 0.152)。どの区画でも claude-mem (窓あり・なし) を下回らない (決定 22)。
